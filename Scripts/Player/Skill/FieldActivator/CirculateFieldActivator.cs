...
{
    public class CirculateFieldActivator : IFieldActivator
    {
        ...
        )
        {
            for (var i = 0; i < numberOfSkill; i++)
            {
                ...
                //デフォルトの角度
                const float defaultAngle = 24;
                
                //number of skillに応じて360度を等分した角度を求める
                ...
                fieldComponent.EnableCircularController(direction, speed);
            }
        }
